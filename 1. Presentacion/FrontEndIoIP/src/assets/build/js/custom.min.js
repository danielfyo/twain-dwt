...
function init_daterangepicker() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        var
            a = function(a, b, c) {
                $('#dateRange').val(a.format('MMMM D, YYYY') + " - " + b.format('MMMM D, YYYY')),
        ...
        $("#reportrange span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")),
            $('#initialDate').val(moment().format('DD/MM/YYYY ') + ' 00:00:01'),
            $('#finalDate').val(moment().format('DD/MM/YYYY HH:mm:ss')),
            ...
            $("#reportrange").on("apply.daterangepicker",
                function(a, b) {
                    ...
                    $('#initialDate').val(b.startDate.format('DD/MM/YYYY HH:mm:ss'));
                    $('#finalDate').val(b.endDate.format('DD/MM/YYYY HH:mm:ss'));
