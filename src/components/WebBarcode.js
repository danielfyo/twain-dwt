...
import { Alert, Badge, Button, Modal, Spinner, Card } from 'react-bootstrap';
...
class WebBarcode extends React.Component {
        ...
        return (
            <>
                <h1><Badge variant="secondary">{this.props.title} </Badge></h1>
                        ...
                        <h3><Alert variant="info">Leer códigos de barras desde archivos</Alert></h3>
                        <Alert variant="warning">Solo soporta PNG, BMP, JPG, GIF y PDF</Alert>
    ...
    onIptChange = event => {
        ...
        (async () => {
            try {
                this.emptyMessages();
                this.appendMessage("======== iniciando lectura del código... ========");
                ...
                for (let i = 0; i < files.length; ++i) {
                    ...
                    this.appendMessage("lectura finalizada en " + timeElapsed.toString() + " milisegundos");
                    if (results.length === 0) {
                        ...
                        for (let i = 0; i < results.length; i++) {
                            ...
                            this.appendDetails("------------------------------------------------------------------------");
                            this.appendDetails("Código # " + (i + 1).toString() + " en el archivo " + file.name);
                            this.appendDetails("------------------------------------------------------------------------");
                ...
                this.appendMessage("======== Lectura finalizada ========");
            } catch (ex) {
